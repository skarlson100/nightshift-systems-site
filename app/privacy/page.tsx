    ...
    <main className="min-h-screen bg-[#f1eadf] text-[#15130f]">
      <section className="border-b border-[#d9d0c1]">
        <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
          ...
          <h1 className="mt-8 text-4xl font-black tracking-[-0.035em]">Privacy Policy</h1>
      ...
      <section className="mx-auto max-w-3xl px-5 py-12 text-base leading-8 text-[#5f574f] sm:px-8">
        ...
        <h2 className="mt-10 text-xl font-black text-[#15130f]">Information we may collect</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-10 text-xl font-black text-[#15130f]">How information is used</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-10 text-xl font-black text-[#15130f]">Third-party services</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-10 text-xl font-black text-[#15130f]">Security</h2>
        <p className="mt-3">
