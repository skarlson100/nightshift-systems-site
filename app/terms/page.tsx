  ...
  return (
    <main className="min-h-screen bg-[#050608] text-[#f4efe7]">
      ...
      <section className="mx-auto max-w-3xl px-5 py-12 text-base leading-8 text-[#a79f98] sm:px-8">
        ...
        <h2 className="mt-10 text-xl font-semibold text-[#f4efe7]">Use of software and apps</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-10 text-xl font-semibold text-[#f4efe7]">Fleet and compliance records</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-10 text-xl font-semibold text-[#f4efe7]">Availability and changes</h2>
        <p className="mt-3">
